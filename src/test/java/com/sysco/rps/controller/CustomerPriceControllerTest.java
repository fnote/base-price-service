...
class CustomerPriceControllerTest extends BaseTest {
    ...
    void getCustomerPrices_PRCP_2078() {
        ...
        Mono<CustomerPriceResponse> customerPrices = customerPriceController.getCustomerPrices(request, null, null);
        ...
        customerPrices = customerPriceController.getCustomerPrices(request, null, null);
